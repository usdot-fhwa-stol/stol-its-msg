...
- Make sure entire spec file is present in asn1/raw/
...
- Run the following script that checks for docker, cmake and installs them if not found
    - source setup.sh

- PreProcess the Specification file for any duplicate tokens
    -  `python3 utils/codegen/codegen-py/preProcess.py`

- To generate .c and .h files for a given specification files
    - `python3 utils/codegen/asn1ToC/asn1ToC.py -o stol_its_coding`
