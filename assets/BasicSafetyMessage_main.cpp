...
#include "BasicSafetyMessage_converter.hpp"

using json = nlohmann::json;

int main(){

    std::ifstream inputFile("BasicSafetyMessage.json");
    ...
    BasicSafetyMessage_t parsed = to_STRUCT_BasicSafetyMessage(j);
    ...
    BasicSafetyMessage_t *decoded=0;
    ...
    std::cout << "Decoded successfully:\n" << to_JSON_BasicSafetyMessage(*decoded).dump(4) << "\n";
