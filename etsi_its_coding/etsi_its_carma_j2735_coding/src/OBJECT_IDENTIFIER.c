...
#include <etsi_its_carma_j2735_coding/INTEGER.h>
#include <etsi_its_carma_j2735_coding/OBJECT_IDENTIFIER.h>
#include <etsi_its_carma_j2735_coding/asn_codecs_prim.h>
